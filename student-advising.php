...
<head>
    ...
    <title>Student Advising - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        <section>
            ...
            <p>Our Student Advising program provides comprehensive support including FAFSA help, appeals, financial aid letter review, and applying for scholarships/loans.</p>
            <h3>Our Pillars</h3>
            <ul>
                <li>Awarding</li>
                <li>Advising</li>
            ...
            <h3>Advisors</h3>
            <div id="advisors" class="loading">Loading advisors...</div>
        </section>
    </main>
