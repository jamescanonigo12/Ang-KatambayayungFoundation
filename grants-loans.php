...
<head>
    ...
    <title>Grants & Loans - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        <section>
            ...
            <p>Need-based grants that do not need to be repaid.</p>

            <h3>Interest-Free Loans</h3>
            <p>Loans that help bridge financial gaps without interest charges.</p>
        </section>
    </main>
