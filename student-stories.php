...
$stories = $pageContent['student-stories'] ?? ['title' => 'Student Stories', 'content' => 'Default content'];
...
<head>
    ...
    <title><?php echo htmlspecialchars($stories['title']); ?> - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        ...
        <div class="admin-controls">
            <button onclick="editPage('student-stories')">Edit Page</button>
        </div>
        <?php endif; ?>
        <section>
            <h2 id="page-title"><?php echo htmlspecialchars($stories['title']); ?></h2>
            <div id="page-content" contenteditable="<?php echo $isAdmin ? 'true' : 'false'; ?>"><?php echo $stories['content']; ?></div>
        </section>
    </main>
