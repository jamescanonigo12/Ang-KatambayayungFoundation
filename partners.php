...
$partners = $pageContent['partners'] ?? ['title' => 'Partners', 'content' => 'Default content'];
...
<head>
    ...
    <title><?php echo htmlspecialchars($partners['title']); ?> - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        ...
        <div class="admin-controls">
            <button onclick="editPage('partners')">Edit Page</button>
        </div>
        <?php endif; ?>
        <section>
            <h2 id="page-title"><?php echo htmlspecialchars($partners['title']); ?></h2>
            <div id="page-content" contenteditable="<?php echo $isAdmin ? 'true' : 'false'; ?>"><?php echo $partners['content']; ?></div>
        </section>
    </main>
