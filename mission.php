...
$db = new Database();
$mission = $db->getPageContent('mission') ?? ['title' => 'Mission & Vision', 'content' => 'Default content'];
...
<head>
    ...
    <title><?php echo htmlspecialchars($mission['title']); ?> - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        ...
        <div class="admin-controls">
            <button onclick="editPage('mission')">Edit Page</button>
        </div>
        <?php endif; ?>
        <section>
            <h2 id="page-title"><?php echo htmlspecialchars($mission['title']); ?></h2>
            <div id="page-content" contenteditable="<?php echo $isAdmin ? 'true' : 'false'; ?>"><?php echo $mission['content']; ?></div>
        </section>
    </main>
