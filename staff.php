...
$staff = $pageContent['staff'] ?? ['title' => 'Staff', 'content' => 'Default content'];
...
<head>
    ...
    <title><?php echo htmlspecialchars($staff['title']); ?> - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        ...
        <div class="admin-controls">
            <button onclick="editPage('staff')">Edit Page</button>
        </div>
        <?php endif; ?>
        <section>
            <h2 id="page-title"><?php echo htmlspecialchars($staff['title']); ?></h2>
            <div id="page-content" contenteditable="<?php echo $isAdmin ? 'true' : 'false'; ?>"><?php echo $staff['content']; ?></div>
        </section>
    </main>
