...
<head>
    ...
    <title>How to Apply - Ang Katambayayung Foundation</title>
...
<body>
    ...
    <main>
        <section>
            <h2>How to Apply</h2>
            <p>Applications are hosted on our partner platform. Follow these steps:</p>
            <ol>
                <li>Go to the application hub at <a href="https://example.academicworks.com">AcademicWorks</a>.</li>
                <li>Sign up for an account.</li>
                <li>Complete the General Application.</li>
                <li>Complete opportunity-specific questions and upload documents.</li>
            </ol>
            <p>Application cycle begins January 1 and typically ends April 15. Awards are announced in May/June.</p>
        </section>
    </main>
